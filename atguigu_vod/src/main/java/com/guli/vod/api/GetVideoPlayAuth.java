...
public class GetVideoPlayAuth {
    //账号AccessKey信息请填写(必选)
    private static String access_key_id = "LTAIjDanEwf9RVXP";
    //账号AccessKey信息请填写(必选)
    private static String access_key_secret = "v23qo8tptfAscACX44QO56XedG5Owk";
    ...
    private final static Logger LOG = Logger.getLogger(GetVideoPlayAuth.class.getName());
    ...
    public static void main(String[] args) throws Exception {
        ...
        //http://vod.cn-shanghai.aliyuncs.com/?Action=GetVideoPlayAuth&VideoId=93ab850b4f6f44eab54b6e91d24d81d4&Format=JSON&<公共参数>
        //发送HTTP GET 请求
        httpGet(URL);
    }
    /**
    ...
    private static Map<String, String> generatePrivateParamters() {
        ...
        // 视频ID
        privateParams.put("VideoId","5acfd9e678d143ff80c064b493abeb3f");
        // API名称
